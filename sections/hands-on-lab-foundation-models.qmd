...
3. Code
The code is available at [github.com/ncsa/cyber2a-workshop](https://github.com/ncsa/cyber2a-workshop/blob/main/foundation_models/hands_on/rag.ipynb). Feel free to clone or download this repo directly from GitHub.
Steps to clone the repo and access the rag.ipynb file:
    1. Open a terminal
    2. Run command: `git clone https://github.com/ncsa/cyber2a-workshop`
