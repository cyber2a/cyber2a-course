...
## Overview
The hands-on lab on foundation models will focus on building and applying foundation models for some example use cases. The main goal of this 1-hour session is to get more familiarized with foundation models and in interacting with them.
