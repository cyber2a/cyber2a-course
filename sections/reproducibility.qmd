...
![Avoid using an absolute path to read in your data as shown here](../images/absolutepath.png)

- Clean your data *within* your code
- Avoid copy/pasting in a spreadsheet
- Always keep an unedited version of your raw data

![The Reproducibility Spectrum by Altuna Akalin in Towards Data Science](../images/ReproSpectrum.png)

## Model Repositories
**PyTorch Hub** is a pre-trained model repository designed to facilitate reproducibility and enable new research. It is easily usable with [Colab](https://colab.google/) and [Papers with Code](https://paperswithcode.com/), but models must be trained on openly accessible data.
	
- [Papers with Code](https://paperswithcode.com/) is an open source hub for publications that include direct links to GitHub code, no account needed to access datasets.
![Example paper with attached code from Papers with Code](../images/PaperswithCode.png)
## Version Control
...
## Summary
Consider the following to ensure your model is repproducible:
