...
![](/images/data-annotation/iris-table.jpg){width=80%}
...
![](/images/data-annotation/muir-quote.jpg){width=80%}
...
![](/images/data-annotation/canyon-wren-song.png){width=80%}
...
![](/images/data-annotation/annotated-video.gif){width=80%}
...
The type of annotation you apply will depend partly on the task, as different annotation types are naturally suited for different tasks. However, the decision will also be driven in part by time, cost, and accuracy considerations.

::: {.callout-caution collapse="true" icon="false"
     title="Bounding boxes"}
**Bounding boxes** are rectangles drawn around objects to localize them within an image.
![](/images/data-annotation/building-bbox.jpg){width=80%}

Typically they are _axis-aligned_, meaning two sides are parallel with
the image top/bottom, and two sides are parallel with the image sides, but
sometimes rotation is supported.
:::
...
![](/images/data-annotation/building-polygon.jpg){width=80%}
:::
...
![](/images/data-annotation/building-segmentation.jpg){width=80%}
:::
...
![](/images/data-annotation/buildings-points.jpg){width=80%}
:::
...
![](/images/data-annotation/road-lines.jpg){width=80%}
:::
...
![](/images/data-annotation/bear-3dcuboid.jpg){width=80%}
:::
